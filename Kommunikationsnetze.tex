...
\symbolbox{
	\begin{tabular}{cl}
	$w_S$ & Anzahl ausstehender ACKs \\
	$SN_{\ir s1}$ & niedrigste Nummer der noch nicht quittierten Nachricht \\
	$SN_{\ir s2}$ & Sendenummer der zuletzt quittierten Nachricht \\
	$SN_{\ir E1}$ & Nummer der nächsten zu empfangenden Nachricht \\
	$SN_{\ir E2}$ & max. mögl. Nr. der nächsten zu empf. Nachricht \\ 
	\end{tabular}
} 
